...
Ext.define('NewsPaper.view.TransferEmployeeGridView', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.transferEmployeeGridView',
    id: 'transferEmployeeGridView',
    store: 'AllEmployeeStore',
    columns: [
   		{xtype: 'rownumberer'},
        {
            text: 'ID',
    ...
    tbar: [
        ...
        '-',
        {
            itemId: 'filterTEmployee', xtype: 'button', text: '查询', iconCls: 'Arrowrefresh'
        },
        '-',
        {
            itemId: 'resetFilterTEmployee', xtype: 'button', text: '清空', iconCls: 'Arrowundo'
        }
    ]
